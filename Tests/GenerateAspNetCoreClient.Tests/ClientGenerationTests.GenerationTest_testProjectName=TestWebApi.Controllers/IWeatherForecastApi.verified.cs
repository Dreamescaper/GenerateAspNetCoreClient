...
namespace Test.Name.Space
{
    public partial interface IWeatherForecastApi
    {
        ...
        [Post("/WeatherForecast/form-collection")]
        Task WithFormCollectionParam([Body(BodySerializationMethod.UrlEncoded)] Dictionary<string, string> formParam, string queryParam = null);
